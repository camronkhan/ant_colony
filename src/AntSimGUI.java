...
public class AntSimGUI extends JFrame
{
	 ...
	 */
	public void addSimulationEventListener(SimModel listener)
	{
	 ...
	 */
	public void removeSimulationEventListener(SimModel listener)
	{
	...
	private void fireSimulationEvent(int eventType)
	{
		...
		{
			((SimModel)itr.next()).simulationEventOccurred(simEvent);
		}
